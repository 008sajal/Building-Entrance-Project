...
mongoose.connect('mongodb+srv://admin:admin@cluster0.0ptic.mongodb.net/building-entrance?retryWrites=true&w=majority')
.then(()=>{
...
function sendemail(email,cinh,cinm){
   ...
   const  sendgrid='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';
  ...
  const msg={
      to: 'sajalvats0008@gmail.com',
      from: 'sajal1595.cse19@chitkara.edu.in',
